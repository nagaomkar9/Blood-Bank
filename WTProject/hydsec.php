...
<html>
    ...
    <br><br>
    <marquee><b><font size="5" color="green">The List Of Our Blood Banks in Hyderabad & Secunderabad</font></b></marquee>
    <br><br>
    <center>
        <font size="5"><b>Aarohi Blood Bank</b></font>
    <hr align="center" width="25%" color="purple">
    <p><b>Address:</b> D.No. 6-3-182/1 To 3, 3rd Floor, Lake View Plaza No. 1, Road No. 1, Banjarahills<br>
    ...
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> House No 4-1-16, H-01, Boggulakunta, Tilak Road, Himayat Nagar<br>
        <b>Pincode:</b> 500029<br>
    ...
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> Apollo Enterprises,DMRL X Roads, Kanchanbagh<br>
    ...
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> 2nd Floor, #6-3-661, Somajiguda<br>
    ...
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> No. 08-16-01, Shantivanam, Sowbhagyanaga, Sagarroad, Saroornagar<br>
    ...
    <p>
        <b>Address:</b> Ground Floor, Road No. 14, Banjara Hills<br>
        <b>Contact:</b> 040 23551235<br>
    </p>
     <font size="5"><b>Challa Blood Bank</b></font>
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> H.No. 7-1-71/A/1, First Floor Part, Dharam Karam Road, Ameerpet<br>
