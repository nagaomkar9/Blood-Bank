...
<html>
    ...
    <br><br>
    <marquee><b><font size="5" color="green">The List Of Our Blood Banks in Bengaluru</font></b></marquee>
    <br><br>
    <center>
        <font size="5"><b> General  Blood Bank</b></font>
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> Ground Floor, Government General Hospital Premises, Bengaluru<br>
        <b>Contact:</b> 0866 2452244, 0866 2452844<br>
    </p>
    <font size="5"><b>Lions Blood Bank </b></font>
    <hr align="center" width="25%" color="purple">
    <p>
        <b> Address:</b> Door No. 29-19-85, First Floor, & Second Floor, Old Janata Hospital Building, Dornakol Road,Bengaluru<br>
        <b>Contact:</b> 9392120187<br>
    </p>
    <font size="5"><b>Indian Red Cross Society Blood Bank</b></font>
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> Near District Area Hospital,Bengaluru<br>
    ...
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> Near Cyber Towers of Prasanthigram,Bengaluru<br>
            <b>Contact:</b> 08555 287900, 08555 287388, 08555 287554<br>
    </p>
    <font size="5"><b>Arogyavaram Medical Centre Blood Bank</b></font>
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> Ground Floor, D.No. 16-1, Bartons Laboratory, AMC Sanitorium, Arogyavaram,Bengaluru<br>
        <b>Contact:</b>08555 287922, 08555 287845<br>
    </p>
    <font size="5"><b>District Head Quarter Hospital Blood Bank</b></font>
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> 1st Floor, District Head Quarter Hospital Premises,Bengaluru<br>
        <b>Contact:</b> 08572 22087<br>
    </p>
    <font size="5"><b>Sri Venkata Sai Charitable Trust Blood Bank</b></font>
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> H. No. 10-3-206, M4, First Floor, Reddy & Reddy Colony, Varadaraja Nagar,Bengaluru<br>
    ...
    <hr align="center" width="25%" color="purple">
    <p>
        <b> Address:</b> Sri Venkateswara Institute Of Medical Sciences Hospital Premises,chennai<br>
        <b>Contact:</b> 0877 2287777<br>
    </p>
    <font size="5"><b>Svrr Government General Hospital Blood Bank</b></font>
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> 1st Floor, Main Building, SSVR Hosital Permises, Bengaluru<br>
        <b>Contact:</b> 08771 2286666<br>
    </p>
    <font size="5"><b>Ariaria Blood Bank</b></font>
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> 1st Floor, District Hospital Premises,Bengaluru<br>
    ...
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> Laxmipuram, NH.5, Rajanagaram Mandal, Bengaluru<br>
    ...
    <hr align="center" width="25%" color="purple">
    <p>
        <b>Address:</b> D.No. 77-1-2, 1st Floor, Jagruthi Building, Bengaluru<br>
